...
- 我们在真正落地时，要克制提云原生这个词，我们讨论[容器](container-tldr.md)、[Dockerfile](container-run-tldr.md#dockerfile)，讨论 [Kubernetes](k8s-tldr.md) 和主要的 Object，讨论 [Helm Chart](helm-tldr.md) 或 Kustomize，讨论 [Git](git-tldr.md) 工作流和 [CI/CD](cicd-tldr.md)，讨论 Java、Spring 的版本[升级](cn-transform.md#升级)，每掌握一个具体的技术点、每解决一个技术债，我们就离云原生近一点；而如果我们只讨论范范的云原生、数字化，只"聚焦"在业务开发，那也是求仁得仁。
